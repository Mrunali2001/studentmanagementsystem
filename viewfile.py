...
class viewdata:
    def  __init__(self):
         ...
         self.root3.geometry("1380x800+8+8")
         self.root3.configure(bg="#D49A89")
         self.root3.state('zoomed')
         label1=Label(self.root3,text="WELCOME TO STUDENT MANAGEMENT SYSTEM",bg="#30475E",fg="black",font=("oswald",20,"bold"),width=50)
         label1.place(x=0,y=0,relwidth=1)
         l1=Label(self.root3,text="RollNo:",bg="#164A58",fg="white",font=("oswald",18,"bold"))
         l1.place(x=200,y=160)
         #e1=Entry(self.root3,width=50,bg="white")
         #e1.place(x=290,y=160)
         self.rollno=StringVar()

         self.e11=Entry(self.root3,textvariable=self.rollno,width=20)
         self.e11.config(font=("oswald",20,"bold"))
         self.e11.place(x=300,y=160)
         self.b1=Button(self.root3,bg="#164A58",width=15,fg="white",text="Retrive",command=self.editrecord)
         self.b1.config(font=("oswald",15,"bold"))
         self.b1.place(x=515,y=160)
    ...
    def editrecord(self):
        ...
        mydb.commit()
        mydb.close()    
        l2=Label(self.root3,text="Roll No:",bg="red",fg="black")
        l2.config(font=("oswald",12,"bold"))
        l2.place(x=200,y=250)
        l3=Label(self.root3,text="Name:",bg="red",fg="black")
        l3.config(font=("oswald",12,"bold"))
        l3.place(x=200,y=280)
        l4=Label(self.root3,text="Standard:",bg="red",fg="black")
        l4.config(font=("oswald",12,"bold"))
        l4.place(x=200,y=310)
        l5=Label(self.root3,text="Section",bg="red",fg="black")
        l5.config(font=("oswald",12,"bold"))
        l5.place(x=200,y=340)
        l6=Label(self.root3,text="Gender",bg="red",fg="black")
        l6.config(font=("oswald",12,"bold"))
        l6.place(x=200,y=370)
        l7=Label(self.root3,text="Address",bg="red",fg="black")
        ...
        self.gen=StringVar()
        self.add=StringVar()
        self.e1=Entry(self.root3,width=32,textvariable=self.rollno,bg="white",font=("oswald",12,"bold"))
        self.e1.insert(0,self.a)
        self.e1.place(x=300,y=250)
        self.e2=Entry(self.root3,width=32,textvariable=self.name,bg="white",font=("oswald",12,"bold"))
        self.e2.insert(0,self.b)
        self.e2.place(x=300,y=280)
        self.e3=Entry(self.root3,width=32,textvariable=self.std,bg="white",font=("oswald",12,"bold"))
        self.e3.insert(0,self.c)
        self.e3.place(x=300,y=310)
        self.e4=Entry(self.root3,width=32,bg="white",textvariable=self.sec,font=("oswald",12,"bold"))
        self.e4.insert(0,self.d)
        self.e4.place(x=300,y=340)
        self.e5=Entry(self.root3,width=32,bg="white",textvariable=self.gen,font=("oswald",12,"bold"))
        ...
        self.e6=Entry(self.root3,width=35,bg="white",textvariable=self.add,font=("oswald",12,"bold"))
        self.e6.insert(0,self.f)
        self.e6.place(x=300,y=400)
        self.b1=Button(self.root3,text="Exit",command=self.root3.destroy,width=15,bg="#164A58",fg="white")
        self.b1.config(font=("oswald",15,"bold"))
